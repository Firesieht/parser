...
with open('трансформатор1.csv', 'r', newline='') as csvfile:
     spamreader = csv.reader(csvfile, delimiter=' ', quotechar='|')
     arts = ([i[0] for i in spamreader])[25:50]
...
with open("трансформатор2.json", "w") as outfile:
    json.dump(result, outfile, ensure_ascii=False)
    
for art in arts:
    data = getDataArt(art)
    file_name = 'трансформатор2.json'
